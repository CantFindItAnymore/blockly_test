...
class ComponentDidMount extends Blockly.Field {
  SERIALIZABLE = true;

  static fromJson(options) {
    return new ComponentDidMount(options['text']);
  }
...
Blockly.fieldRegistry.register('component_did_mount', ComponentDidMount);
